    ...
    <b-navbar-nav class="align-items-center ml-auto ml-md-0">
        ...
        <b-form-group class="mb-0">
          <b-input-group class="input-group-alternative input-group-merge">
            <b-form-input placeholder="Search" type="text" v-model="searchText"> </b-form-input>

            <div class="input-group-append" v-if="searchText!=''" @click="searchHere()">
        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    {{  userDetails && initials((userDetails).name)}}
                  </span>
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-sm  font-weight-bold">{{userDetails && userDetails.name}}</span>
            </b-media-body>
          </b-media>
        </a>
...
import { debouncing } from '@/util/throttle.js';
