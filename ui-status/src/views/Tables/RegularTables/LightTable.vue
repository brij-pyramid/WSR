<template>
    ...
    <b-card no-body>
      ...
      <b-button type="submit" variant="primary" @click="adduser()">Add User</b-button>
       </b-card-header>
        <b-card-header class="border-0">
        ...
        <el-table class="table-responsive table"
            ...
            <el-table-column label="Completion"
                ...
                <template v-slot="{row}">
                    ...
                    <b-button type="submit" variant="primary" @click="deteteData(row.id)">Delete</b-button>
                    <b-button type="submit" variant="primary" @click="editData(row.id)">Edit</b-button>
