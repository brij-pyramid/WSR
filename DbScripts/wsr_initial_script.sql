...
CREATE TABLE projects_status (
    ...
    `timeline` INT(11) NOT NULL COMMENT '1-On Track, 2-Low, 3-medium, 4-High, 5-On Hold',
    `quality` INT(11) NOT NULL COMMENT '1-On Track, 2-Low, 3-medium, 4-High, 5-On Hold',
    `customer` INT(11) NOT NULL COMMENT '1-On Track, 2-Low, 3-medium, 4-High, 5-On Hold',
    `resources` INT(11) NOT NULL COMMENT '1-On Track, 2-Low, 3-medium, 4-High, 5-On Hold',
